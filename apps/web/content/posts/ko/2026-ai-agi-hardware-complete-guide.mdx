...
- **2028년**: 완전 자율 AI 연구원
- **현재 상태**: GPT-5 출시 완료, GPT-5.2까지 릴리스, o3 추론 모델 운영 중
...
GPT-5는 세 가지 사이즈로 제공됩니다: `gpt-5`, `gpt-5-mini`, `gpt-5-nano`
...
**GPT-5.2 새 기능 - Reasoning Effort "none":**
...
| 고속 추론 + 도구 호출 | GPT-5.2 | 400K 컨텍스트, 병렬 도구 호출 |
| 수학/과학 추론 | o3 (high effort) | 추론 토큰 특화 |
| 비용 민감 앱 | GPT-5-nano / Gemini 3 Flash | 저비용 고성능 |
