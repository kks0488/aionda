...
물론 장밋빛 전망만 있는 것은 아닙니다. 일각에서는 보도된 100억 달러 규모의 계약 금액이 주는 재무적 압박과 세레브라스 장비의 높은 전력 소모량을 우려합니다. 거대한 단일 칩 아키텍처는 발열 관리와 전력 공급 측면에서 기존 방식보다 훨씬 까다로운 엔지니어링 역량을 요구하기 때문입니다. 또한, 세레브라스 장비가 OpenAI의 차기 모델들과 얼마나 매끄럽게 소프트웨어적으로 통합될 수 있을지도 지켜봐야 할 대목입니다.
