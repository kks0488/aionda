---
title: 'GPT 5.2.1 Codex: 24시간 자율 코딩하는 AI 에이전트의 실체'
slug: openai-gpt-5-1-codex
date: '2025-11-13'
locale: ko
excerpt: >-
  OpenAI GPT 5.2.1 Codex Max는 Compaction 기술로 컨텍스트 한계를 극복하고, 24시간 이상 자율 작업을 수행합니다.
...
OpenAI는 2025년 11월, **GPT 5.2.1 Codex Max**를 출시하며 Compaction 기술로 대규모 프로젝트 컨텍스트 한계를 돌파했습니다. (해결책)
...
**하위 호환성**:
GPT 5.2.1 Codex는 2026년 11월까지 지원 (1년 병행 운영).
...
GPT 5.2.1 Codex Max는 단순 코드 생성을 넘어 **자율 프로젝트 관리 시대**를 열었습니다.
...
- [OpenAI Platform Changelog](https://platform.openai.com/docs/changelog) - GPT 5.2.1 Codex 공식 발표
