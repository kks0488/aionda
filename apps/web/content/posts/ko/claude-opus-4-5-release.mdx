...
date: "2025-11-24"
excerpt: "Anthropic이 Claude Opus 4.5를 공개했습니다. SWE-bench Verified 80.9%로 GPT-5.1 Codex Max를 제치고 코딩 1위를 차지했으며, 가격은 Opus 4.1 대비 1/3로 낮췄습니다. 200K 컨텍스트, 64K 출력, Computer Use 기능까지 탑재한 이 모델의 실체를 데이터로 검증합니다."
tags: ["Anthropic", "Claude", "Opus 4.5", "AI Model", "SOTA", "LLM", "Coding AI"]
...
성능 좋은 모델은 비싸고, 싼 모델은 성능이 떨어집니다. 그래서 개발자들은 작업마다 GPT-4, Claude Sonnet, Gemini를 번갈아 쓰며 비용과 품질 사이에서 고민합니다.

2025년 11월 24일, Anthropic은 **Claude Opus 4.5**로 이 딜레마를 정면 돌파했습니다. (해결책)
SWE-bench Verified에서 **80.9%**를 기록하며 GPT-5.1 Codex Max(77.9%)와 Sonnet 4.5(77.2%)를 제치고 1위를 차지했고, 가격은 Opus 4.1 대비 **input $5/M, output $25/M**으로 1/3 수준입니다. (근거)
...
70점은 GPT-5.1 High와 동점이며, Gemini 3 Pro보다 3점 낮습니다. 하지만 **비용 대비 성능**에서는 압도적 우위를 차지합니다 (아래 섹션 참조).
...
- GPT-5.1: (5K × $8/M × 10,000) + (2K × $40/M × 10,000) = **$400 + $800 = $1,200**
- **절감액: $450 (37.5% 저렴)**
...
**GPT-5.1 선택 시:** OpenAI 에코시스템 통합 필요
...
### Q2: GPT-5.1과 비교했을 때 Opus 4.5의 강점은 무엇인가요?
