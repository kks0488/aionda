...
locale: en
description: >-
  Analyzes the gap between AI math coaches' official benchmark scores and their
  real-world problem-solving performance, offering practical usage tips.
tags:
  - AI 수학 코치
  - Gemini
  - 수능 수학
...
- 🏛️ [Gemini 3: Unlocking multimodal understanding across millions of tokens of context - arXiv](https://arxiv.org/abs/2403.05530)
