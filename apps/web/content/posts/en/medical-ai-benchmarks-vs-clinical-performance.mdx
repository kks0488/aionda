...
- 🛡️ [M42 launches MEDIC Leaderboard to benchmark clinical LLMs](https://dharab.com/m42-launches-medic-leaderboard-to-benchmark-clinical-llms/)
- 🛡️ [MedEthicsQA: A Comprehensive Question Answering Benchmark for Medical Ethics Evaluation of LLMs](https://www.researchgate.net/publication/393183729_MedEthicsQA_A_Comprehensive_Question_Answering_Benchmark_for_Medical_Ethics_Evaluation_of_LLMs)
...
- 🏛️ [Large Language Models Encode Clinical Knowledge - MultiMedQA](https://arxiv.org/abs/2212.13138)
