...
NVIDIA’s latest move is a strategy to encourage enterprises to move away from OpenAI through open models. For corporations, closed models like GPT-4o are like black boxes. Concerns about data leakage are high, and the costs incurred with every call are difficult to control. NVIDIA capitalizes on this pain point. By deploying open models like Nemotron on-premise or in private clouds, companies can build "Sovereign AI," protecting data sovereignty while reducing inference costs by up to 60%.
