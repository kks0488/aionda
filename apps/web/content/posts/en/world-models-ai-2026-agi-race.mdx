...
LeCun's LLM critique isn't mere competitor disparagement but grounded in information theory. Humans experience roughly 20,000 seconds during 16 waking hours, processing 2 million pixels per second (both eyes). At 8 bits per pixel, that's approximately 320GB of visual information daily. Meanwhile, GPT-5 generates about 50,000 words (400,000 tokens) daily—roughly 2.5MB.
...
According to Meta AI Research's 2024 paper, LLMs achieved 62% human-level accuracy on commonsense physics reasoning benchmarks. GPT-5 correctly answers "what happens if you place a steel ball on water?" but frequently fails with "what happens if you place a thin steel boat shaped like a ball on water?"
