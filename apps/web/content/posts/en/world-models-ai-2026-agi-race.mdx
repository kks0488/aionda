...
date: '2026-01-12'
excerpt: "Yann LeCun's Meta departure and €500M AMI Labs launch, Runway GWM-1 and World Labs Marble releases mark 2026 as the year AI moves beyond LLMs to understand the physical world."
...
LeCun's LLM critique isn't mere competitor disparagement but grounded in information theory. Humans experience roughly 20,000 seconds during 16 waking hours, processing 2 million pixels per second (both eyes). At 8 bits per pixel, that's approximately 320GB of visual information daily. Meanwhile, GPT-4 generates about 10,000 words (80,000 tokens) daily—roughly 0.5MB.
...
According to Meta AI Research's 2024 paper, LLMs achieved 62% human-level accuracy on commonsense physics reasoning benchmarks. GPT-4 correctly answers "what happens if you place a steel ball on water?" but fails with "what happens if you place a thin steel boat shaped like a ball on water?" Unable to reason about unseen combinations.
