...
Many people talk about the limits of AI, seeing that no groundbreaking model has emerged since GPT-5.
...
- **System 1 (Intuition)**: Current chatbots that react instantly to questions (e.g., GPT-5).
...
### Q3. What is the status of GPT-5?
**A.** GPT-5 and GPT-5.2 have already been released, and they have evolved into forms where "reasoning capability" is internalized, rather than just having "lots of training data."
