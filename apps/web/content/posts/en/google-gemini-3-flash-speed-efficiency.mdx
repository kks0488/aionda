...
The heartbeat of Gemini 3 Flash pumps out over 200 output tokens per second (TPS). Compared to the previous generation, Gemini 1.5 Flash, which remained at around 60 TPS, this represents a 3.3x leap. It is not just about raw output speed. Through an optimization process that removes unnecessary filler from responses, Google has reduced token consumption for the same tasks by approximately 30%.
