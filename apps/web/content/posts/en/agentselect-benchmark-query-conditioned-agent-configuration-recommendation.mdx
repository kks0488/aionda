...
locale: en
description: >-
  AgentSelect defines narrative-query to end-to-end agent configuration
  recommendation, proposing a benchmark with queries, agents, and interactions.
tags:
  - hardware
  - llm
  - deep-dive
...
alternateLocale: /ko/posts/agentselect-benchmark-query-conditioned-agent-configuration-recommendation
  /ko/posts/agentselect-benchmark-query-conditioned-agent-configuration-recommendation
coverImage: >-
  /images/posts/agentselect-benchmark-query-conditioned-agent-configuration-recommendation.png
---
