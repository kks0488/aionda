...
locale: en
description: >-
  The tech gap between Boston Dynamics' Atlas and Chinese humanoids like Unitree
  H1 lies in dynamic performance like jump height and landing stability. We
  analyze the differences in design philosophy and control algorithms.
tags:
  - 휴머노이드 로봇
  - 보스턴 다이내믹스
  - 아틀라스
