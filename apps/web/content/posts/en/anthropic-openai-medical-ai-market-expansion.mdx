...
However, it is not all rosy outlooks. Some analyses suggest it could take decades for Merge Labs' non-invasive interface technology to reach the actual consumer market. Additionally, conflicting reports on the acquisition price of Torch ($60 million to $100 million) suggest opacity behind the rapidly growing market. Doubts also remain in the field regarding whether technically perfect ‘Zero-retention’ can operate flawlessly in actual cloud environments without configuration errors by practitioners.
