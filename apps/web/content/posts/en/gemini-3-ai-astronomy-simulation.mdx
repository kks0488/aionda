...
- 🛡️ [AI helps distinguish dark matter from cosmic noise - ScienceDaily](https://www.sciencedaily.com/releases/2024/09/240906141702.htm)
...
- 🏛️ [Revolutionizing Scientific Discovery with AI: Inside the Science Discovery Engine | NASA Science](https://science.data.nasa.gov/learn/blog/artificial-intelligence-data-discovery)
- 🏛️ [Gemini thinking | Gemini API - Google AI for Developers](https://ai.google.dev/gemini-api/docs/thinking)
