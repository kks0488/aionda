...
To ensure objectivity in this process, Google introduced an 'Ensemble of Judges.' This method involves employing top-tier models such as Gemini 3 Pro and GPT-5 as evaluators to reach a consensus.
...
**Q: Isn't it too expensive to use GPT-5 or Gemini 3 as evaluator models?**
**A:** Yes, it is costly.
